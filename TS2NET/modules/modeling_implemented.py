...
from modules.GSG import Scale_Block, GSG
...
class CLIP4Clip(CLIP4ClipPreTrainedModel):
    def __init__(self, cross_config, clip_state_dict, task_config):
        ...
        self.k = 8
        self.EncoderBlock = nn.Sequential(*[Scale_Block(cross_config.hidden_size,4) for _ in range(int(self.k/2))])
    ...
    def get_similarity_logits(self, sequence_output, visual_output, attention_mask, video_mask, shaped=False, loose_type=False):
        ...
        if loose_type:
            ...
            sim_matrix_global, sim_matrix_semantic = self._loose_similarity(sequence_output, visual_output, attention_mask, video_mask, sim_header=self.sim_header)
        else:
