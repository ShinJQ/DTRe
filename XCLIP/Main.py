...
from modules.modeling_xclip_Implemented import XCLIP
...
def prep_optimizer(args, model, num_train_optimization_steps, device, n_gpu, local_rank, coef_lr=0.1):
...
def main():
    ...
    if args.do_train:
        ...
        if args.local_rank == 0:
            model = load_model(1, args, n_gpu, device)
            eval_epoch(args, model, test_dataloader, device, n_gpu)
