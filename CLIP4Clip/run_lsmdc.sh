...
--data_path ${DATA_PATH} --features_path ${DATA_PATH}/Compressclips \
--output_dir ckpts/ckpt_lsmdc_retrieval_looseType --lr 1e-4 \
--max_words 32 --max_frames 12 --batch_size_val 64 --datatype lsmdc \
